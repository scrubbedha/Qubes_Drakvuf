...
7. `altp2m=1`:  Last but not least, this this boolean enables Xen's alternate p2m (physical-to-machine) functionality that is a [game changer for external monitoring](https://github.com/tklengyel/drakvuf/wiki/Xen-altp2m#stealthy-monitoring-with-xen-altp2m)
